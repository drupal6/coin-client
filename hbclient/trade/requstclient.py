from hbclient.trade.constant.system import RestApiDefine
from hbclient.trade.impl.restapirequestimpl import RestApiRequestImpl
from hbclient.trade.impl.restapiinvoker import call_sync
...
class RequestClient(object):
    ...
    def __init__(self, **kwargs):
        ...
        :param kwargs: The option of request connection.
            ...
            server_url: The URL name like "https://api.hbclient.trade.pro".
        """
        api_key = None
        secret_key = None
